  ...
  return (
    <div key={-1} className="flex flex-col items-center justify-center p-8 gap-4">
      <PropagateLoader 
        ...
        size={12}
      />
      <span className="text-xs text-slate-400 font-medium tracking-wide animate-pulse">
...
export const WaitingSpinner = () => {
  return (
    <div key={-1} className="flex items-center gap-2 py-1 px-2 text-indigo-400">
      <BeatLoader 
        color="#818cf8"
        speedMultiplier={0.8}
        size={8}
...
export const ThinkingSpinner = () => {
  return (
    <div key={-1} className="flex items-center gap-3 py-1 px-2 text-indigo-400">
      <BeatLoader 
        color="#818cf8"
        speedMultiplier={0.8}
        size={8}
